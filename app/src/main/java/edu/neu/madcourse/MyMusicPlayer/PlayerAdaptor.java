...
public class PlayerAdaptor extends RecyclerView.Adapter<PlayerHolder>{
    ...
    private ArrayList<edu.neu.madcourse.MyMusicPlayer.MusicItem> localItems;
//    private ArrayList<File> items;
    public PlayerAdaptor(Context context, ArrayList<edu.neu.madcourse.MyMusicPlayer.MusicItem> localItems) {
...
//        this.items = items;
    ...
    public void onBindViewHolder(@NonNull PlayerHolder holder, int position) {
        edu.neu.madcourse.MyMusicPlayer.MusicItem item = localItems.get(position);
